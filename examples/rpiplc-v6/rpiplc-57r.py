...
def digital_read_write() -> None:
    ...
    print(f"The I0.0 is reading: {read_value}")

    rpiplc.digital_write("Q0.0", rpiplc.LOW)
    rpiplc.delay(1000)


def analog_read_write() -> None:
    ...
    print(f"The I0.2 is reading: {read_value}")
...
def main() -> int | None:
    print(
        f"librpiplc version: {rpiplc.c_version}, python3-librpiplc version: {rpiplc.python_version}"
    )
